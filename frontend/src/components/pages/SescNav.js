      ...
      <div>
        <div className="breadcumb">
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography color="text.primary">СУНЦ</Typography>
          </Breadcrumbs>
        </div>
      ...
      <div className="body-content">
        <div className="breadcumb">
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Link underline="hover" color="inherit" to={"/home-sesc"}>
              СУНЦ
            </Link>
            <Typography color="text.primary">О СУНЦ</Typography>
          </Breadcrumbs>
        </div>
        <h2 className="body-title">О Лицее</h2>
      ...
      <div className="body-content">
        <div className="breadcumb">
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography color="text.primary">Документы</Typography>
          </Breadcrumbs>
        </div>
        <h2 className="body-title">Документы</h2>
        <div className="text-content">
          <p>
            Документы Северо-Восточного федерального университета им. М.К.
            Аммосова.
            <br />
            Документы Специализированного учебно-научного центра–
            Университетского лицея Северо-Восточного федерального университета
            им. М.К. Аммосова.
            <br />
            Положение о СУНЦ
            <br />
            ...
            Лицензия СОО
            <br />
            Свидетельство о государственной аккредитации СОО
            <br />
            Приложение к свидетельству о государственной аккредитации СОО
            <br />
            Приказ о государственной аккредитации СОО
            <br />
            ДОГОВОР об обеспечении обучающегося Специализированного
            учебно-научного центра – Университетского лицея местом в интернате.
          </p>
        </div>
      </div>
    </div>
